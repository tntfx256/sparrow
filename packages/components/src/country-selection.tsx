import type { Option } from "@sparrow/core";
...
export function CountrySelection(props: CountrySelectionProps) {
  const { label, onCountrySelect } = props;

  function handleCountrySelect(country: string) {
    onCountrySelect(country);
  }

  return <Select label={label} name="country" options={countries} value="" onChange={handleCountrySelect} />;
}
